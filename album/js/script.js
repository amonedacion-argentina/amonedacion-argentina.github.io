...
const App = {
    config: {
        ...
        IPFS_HASH: 'QmSjqKyEJeEPN2iyrmAp6qdZ8cb3e5CeC9UJcbMqmQaRF4', // Este sirve para módo incognito o sin Metamask (sino se actualiza automáticamente al iniciar la app).
