...
const App = {
    config: {
        ...
        IPFS_HASH: 'QmRKFomj5XXJb5MVhHUSbkmUZHnkzUnn13ccxtqrcFy5o8', // Este sirve para módo incognito o sin Metamask (sino se actualiza automáticamente al iniciar la app).
