...
const App = {
    config: {
        ...
        IPFS_HASH: 'QmQkqmLQCmnUNbyQLFvU73GmtWYsu2qAfg3huAKAdVXkgV', // Este sirve para módo incognito y si hay Metamask, se actualizará automáticamente al iniciar la app.
