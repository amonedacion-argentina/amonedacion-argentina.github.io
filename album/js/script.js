...
const App = {
    config: {
        ...
        IPFS_HASH: 'QmdURkFFfDYXu9M7yNfwTp7vHkkg5Ty9uWSZ6ArMdNQkbj', // Este sirve para módo incognito o sin Metamask (sino se actualiza automáticamente al iniciar la app).
